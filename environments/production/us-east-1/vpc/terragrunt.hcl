...
inputs = {
  ...
  public_subnets                                  = ["10.70.0.0/24", "10.70.1.0/24", "10.70.2.0/24"] 
  private_subnets                                 = ["10.70.6.0/24", "10.70.7.0/24", "10.70.8.0/24"]
  database_subnets                                = ["10.70.12.0/24", "10.70.13.0/24", "10.70.14.0/24"]
